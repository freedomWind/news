...
namespace UnityGameFramework.Runtime
{
    ...
    {
        public static void StaticLoadBytes(string fileUri, LoadBytesCallbacks loadBytesCallbacks, object userData)
        {
            var bb = GameEntry.GetComponent<BaseComponent>();
            bb.StartCoroutine(LoadBytesCo(fileUri, loadBytesCallbacks, userData));
        }
        ...
        private static IEnumerator LoadBytesCo(string fileUri, LoadBytesCallbacks loadBytesCallbacks, object userData)
        {
            bool isError = false;
            byte[] bytes = null;
